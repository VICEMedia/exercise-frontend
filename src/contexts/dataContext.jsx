...
const DataContextProvider = (props) => {
    ...
    const [isActive, setIsActive] = useState((sessionStorage.getItem('saveCurrentActive')) ? sessionStorage.getItem('saveCurrentActive') : 'a1');
    ...
    useEffect(() => {
        ...
        // otherwise - do update id, but also trigger pushState to update the url with the correct id param
            sessionStorage.setItem('saveCurrentActive', isActive);
            history.pushState({page: 1},'','/?id=' + isActive);
